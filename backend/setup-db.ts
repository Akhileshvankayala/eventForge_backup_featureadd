...
async function main() {
  ...
  // Sessions (model shape: slug/startTime/endTime/roomName/type)
  const sessionInsert = await sessions.insertMany([
    // Future of Work Summit (2026-09-18)
    {
      _id: oid(),
      eventId: futureOfWorkId,
      title: "Opening keynote: The human edge",
      slug: "opening-keynote-the-human-edge",
      time: "09:30",
      duration: 60,
    ...
    },
    {
      ...
      slug: "building-with-responsible-ai",
      time: "11:00",
      duration: 90,
      startTime: new Date("2026-09-18T11:00:00Z"),
      endTime: new Date("2026-09-18T12:30:00Z"),
      timezone: "UTC",
      room: "Atlas room",
      roomName: "Atlas room",
      format: "Workshop",
    ...
    },
    {
      ...
      slug: "culture-as-a-growth-engine",
      time: "13:15",
      duration: 60,
      startTime: new Date("2026-09-18T13:15:00Z"),
      endTime: new Date("2026-09-18T14:15:00Z"),
      timezone: "UTC",
      room: "Forum room",
      roomName: "Forum room",
      format: "Panel",
    ...
    },
    {
      ...
      time: "11:30",
      duration: 90,
      startTime: new Date("2026-10-02T11:30:00Z"),
    ...
    // Design Systems Workshop
    {
      ...
      time: "10:00",
      duration: 120,
      startTime: new Date("2026-10-21T10:00:00Z"),
      endTime: new Date("2026-10-21T12:00:00Z"),
      timezone: "UTC",
      room: "Main hall",
      roomName: "Main hall",
      format: "Workshop",
    ...
    },
    {
      ...
      slug: "from-tokens-to-components",
      time: "14:00",
      duration: 90,
      startTime: new Date("2026-10-21T14:00:00Z"),
      endTime: new Date("2026-10-21T15:30:00Z"),
      timezone: "UTC",
      room: "Track 1",
      roomName: "Track 1",
      format: "Workshop",
  ...
  // Attendees (model shape: firstName/lastName/registrationStatus)
  const gaTicketId = ticketInsert.insertedIds[0];
  const vipTicketId = ticketInsert.insertedIds[1];
  const addonTicketId = ticketInsert.insertedIds[2];
  const attendeeInsert = await attendees.insertMany([
    ...
    },
    {
      ...
      organization: "Leadership First",
      jobTitle: "Workshop pass",
      registrationStatus: "pending",
      ticketTypeId: gaTicketId,
      ticketTypePrice: 499,
      finalPrice: 499,
      checkedIn: false,
      qrCode: "EF-FOW-T002",
    ...
    // Design Systems Workshop
    {
      ...
      jobTitle: "Speaker guest",
      registrationStatus: "approved",
      checkedIn: true,
      checkedInAt: new Date("2026-10-21T09:40:00Z"),
      qrCode: "EF-DSW-N005",
      notes: "Complementary ticket as workshop facilitator",
      createdAt: new Date("2026-08-09T00:00:00Z"),
      updatedAt: new Date("2026-10-21T09:40:00Z"),
    },
    {
      _id: oid(),
      eventId: designSystemsId,
      ...
      organization: "Product Lab",
      jobTitle: "Workshop pass",
      registrationStatus: "approved",
      ticketTypeId: addonTicketId,
      ticketTypePrice: 99,
      finalPrice: 99,
      checkedIn: false,
      qrCode: "EF-DSW-J006",
  ...
  const attendeeDocs = await attendees
    .aggregate([
      ...
      { $unwind: "$event" },
      { $sort: { "event.startDate": 1, createdAt: 1 } },
    ])
    .toArray() as any[];
  for (const a of attendeeDocs) {
    console.log(
      `  ${a.firstName} ${a.lastName} (${a.email})\n    Event: ${a.event.title}\n    Status: ${a.registrationStatus} · Checked in: ${a.checkedIn ? "yes" : "no"} · QR: ${a.qrCode}`
    );
  }
